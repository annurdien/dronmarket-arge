...
T.ComboBox {
    id:             control
    padding:        ScreenTools.isMobile ?  (ScreenTools.comboBoxPadding * 0.5) : ScreenTools.comboBoxPadding
    spacing:        ScreenTools.isMobile ? (ScreenTools.defaultFontPixelWidth * 0.08) : ScreenTools.defaultFontPixelWidth
    ...
    indicator: QGCColoredImage {
        ...
        height:                 ScreenTools.isTinyScreen ? (ScreenTools.defaultFontPixelWidth * 0.2) : ScreenTools.defaultFontPixelWidth
        width:                  height
    ...
    background: Rectangle {
        implicitWidth:  ScreenTools.isMobile ? (ScreenTools.implicitComboBoxWidth * 0.2) : ScreenTools.implicitComboBoxWidth
        implicitHeight: ScreenTools.isMobile ? (ScreenTools.implicitTextFieldHeight * 0.2) : ScreenTools.implicitComboBoxWidth
